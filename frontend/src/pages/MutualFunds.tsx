import { type IScheme, indianFormat, API_ENDPOINT } from "@data/";
...
export const MutualFunds = () => {
	...
	axios
		.get(`${API_ENDPOINT}/portfolio/inventments/`, {
			headers: {
			...
			<div className="w-2/3 py-2">
				<table className="w-full text-left">
					<thead className="border-b border-gray-600 bg-gray-100 py-2">
						<tr>
							<th className="w-1/2 items-start py-4 capitalize pl-2 rounded-tl-md flex text-center">
